    ...
    <div class="container-fluid" style="background-color: rgb(216, 213, 213);">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="row m-4">
                    <div class="col">
                        <form class="form-horizontal" action="adminFunctions.php" method="POST">
                            <div class="row justify-content-start">
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="confirmed">CONFIRMED APPLICANTS</button>
                                </div>
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="accepted">ACCEPTED APPLICANTS</button>
                                </div>
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="rejected">REJECTED APPLICANTS</button>
                                </div>
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="waiting">WAITING APPLICANTS</button>
                                </div>
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="programmes">VIEW PROGRAMMES</button>
                                </div>
                                <div class="col-2 text-center">
                                    <button class="btn btn-primary" name="logout">LOGOUT ACCOUNT</button>
                                </div>
                            </div>
                        </form>
                    </div>
