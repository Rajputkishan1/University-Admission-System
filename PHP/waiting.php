...
<head>
    <meta charset="UTF-8">
    <title>Waiting Applicants</title>
...
<?php
    ...
    $sql_query = "SELECT * FROM userdata WHERE Status='Waiting'";
...
<div class="row" id="logUp" style="background:white; color:black;">
    <div class="col"><h1 class="m-5 text-center"style="font-family:'Courier New';"><strong> WAITING APPLICANT DETAILS</strong></h1></div>
</div>
